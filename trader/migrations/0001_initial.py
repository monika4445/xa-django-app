    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trader', to='accounts.useraccounts', verbose_name='Аккаунт пользователя')),
            ],
            options={
